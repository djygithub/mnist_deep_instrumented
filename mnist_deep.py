...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        print('inference accuracy %g' % accuracy.eval(feed_dict={x: test_image, y_: test_label, keep_prob: 1.0}))
        end = datetime.datetime.now()
        diff = end - start
        result = diff.total_seconds()
        diff_train = train_end - train_start
        result_train = diff_train.total_seconds()
        print('train iterations/second %g' % (2000/result_train))
        print('inference images/second %g' % (7000/result))
